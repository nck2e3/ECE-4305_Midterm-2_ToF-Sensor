...
(
   ...
   // PMOD JB (UNUSED PINS ON TOF)...
   assign jb_top[1] = 1'b1; //Keep high, not using IRQ...
   assign jb_top[2] = 1'b1; //Keep high, we're controlling in software...
   assign jb_btm = 4'b1100;
